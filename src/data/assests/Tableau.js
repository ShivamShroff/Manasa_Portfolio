...
const Tableau = (
  <svg height="24" width="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60.3 59.5">
    ...
    <path clip-rule="evenodd" d="M44.3 53.2h2.8v-8h7.5v-2.5h-7.5v-8.1h-2.8v8.1h-7.4v2.5h7.4z" fill="#1f457e" fill-rule="evenodd"/>
